...
public class SearchOperaQuery
{
    ...
    public static ResultSet SearchOperaQueryKeyword(String keyword) throws SQLException {
    ...
    public static ResultSet SearchOperaQueryAutore(String keyword) throws SQLException {
    ...
    public static ResultSet SearchOperaQueryGenere(String keyword) throws SQLException {
